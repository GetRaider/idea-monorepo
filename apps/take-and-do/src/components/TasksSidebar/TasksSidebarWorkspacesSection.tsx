...
export function TasksSidebarWorkspacesSection({
  ...
  const [workspacesSectionOpen, setWorkspacesSectionOpen] = useState(true);
    ...
    <WorkspaceContainer grow>
      <div className="flex min-w-0 items-center justify-between gap-2">
        <SidebarCollapsibleSectionHeader
          ...
          isExpanded={workspacesSectionOpen}
          onToggle={() => setWorkspacesSectionOpen((o) => !o)}
          title="Workspaces"
        />
        <AddButton
