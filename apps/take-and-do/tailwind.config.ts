  ...
  theme: {
    extend: {
      colors: {
        ...
        "chrome-cta-primary-from": "var(--chrome-cta-primary-from)",
        "chrome-cta-primary-to": "var(--chrome-cta-primary-to)",
        "chrome-cta-primary-fg": "var(--chrome-cta-primary-fg)",
        "brand-primary": "var(--brand-primary)",
        "brand-gradient-from": "var(--brand-gradient-from)",
        "brand-gradient-to": "var(--brand-gradient-to)",
        "shell-gradient-from": "var(--shell-gradient-from)",
        "shell-gradient-to": "var(--shell-gradient-to)",
        "chrome-cta-inverted-bg": "var(--chrome-cta-inverted-bg)",
        "chrome-cta-inverted-fg": "var(--chrome-cta-inverted-fg)",
        "chrome-cta-inverted-hover": "var(--chrome-cta-inverted-hover)",
      },
      borderRadius: {
        sm: "var(--radius-sm)",
        md: "var(--radius-md)",
