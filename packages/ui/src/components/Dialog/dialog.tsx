...
export function DialogTitle({ className, ref, ...props }: UiProps<"h2">) {
  return (
    <h2
      ref={ref}
      className={cn(
        "m-0 text-xl font-semibold text-[color:var(--text-primary,#e5e5e5)]",
        className,
      )}
      {...props}
    />
...
export function ConfirmCancelBtn({
  ...
  return (
    <button
      ...
      type={type}
      className={cn(
        "cursor-pointer rounded-lg border border-zinc-600 bg-transparent px-5 py-2.5 text-sm font-medium text-zinc-400 transition-all duration-200 hover:bg-zinc-800 hover:text-[color:var(--text-primary,#e5e5e5)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-400 disabled:cursor-not-allowed disabled:opacity-60 hover:disabled:bg-transparent hover:disabled:text-zinc-400",
        className,
      )}
      {...props}
    />
...
export function ConfirmDangerBtn({
  ...
  return (
    <button
      ...
      type={type}
      className={cn(
        "cursor-pointer rounded-lg border-0 bg-red-900 px-5 py-2.5 text-sm font-medium text-[color:var(--text-primary,#e5e5e5)] transition-colors duration-200 hover:bg-red-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-900/50 disabled:cursor-not-allowed disabled:opacity-60 hover:disabled:bg-red-900",
        className,
      )}
      {...props}
    />
