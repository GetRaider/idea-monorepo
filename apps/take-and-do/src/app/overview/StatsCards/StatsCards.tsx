...
function StatCard({ className, ref, ...props }: UiProps<"div">) {
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-col gap-2 rounded-xl border border-border-app bg-background-primary p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-zinc-500",
        className,
      )}
      {...props}
    />
...
function StatIcon({ className, ref, ...props }: UiProps<"div">) {
  return (
    <div
      ref={ref}
      className={cn(
        "flex h-10 w-10 items-center justify-center rounded-lg bg-input-bg text-zinc-400",
        className,
      )}
      {...props}
    />
...
function StatValue({ className, ref, ...props }: UiProps<"div">) {
  return (
    <div
      ref={ref}
      className={cn(
        "text-[32px] font-bold leading-none text-text-primary",
        className,
      )}
      {...props}
    />
